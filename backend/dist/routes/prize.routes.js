...
router.post('/createPrize', /* adminAuthenticate, */ prize_controller_1.createOnePrize);
router.delete('/:id', /* adminAuthenticate, */ prize_controller_1.deleteOnePrize);
router.put('/:id', /* adminAuthenticate, */ prize_controller_1.updateOnePrize);
/**
 * @swagger
 * tags:
 *   name: Prizes
