                    ...
                    <div className="flex flex-col justify-center items-start text-center">
                        {
                            item.title === 'Goles' ?
                                completedMatch?.goalscorer?.map((goal, i) => (
                                    <div key={i} className="w-full px-[50px] py-1 mx-auto flex items-center justify-between border-b border-gray-300">
                                        <div>
                                            <span>{goal.time}'</span>
                                ...
                                :
                                <div className="w-full px-[50px] py-1 mx-auto flex items-center justify-between border-b border-gray-300">
                                    <div>
                                        <span>20'</span>
